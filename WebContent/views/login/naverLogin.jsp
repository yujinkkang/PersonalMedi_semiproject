 ...
 //alert(naver_id_login.oauthParams.access_token);
  ...
  function naverSignInCallback() {
      ...
      //alert(naver_id_login.getProfileData('id')+"id");
       ...
       // alert(mem_name);
     // alert(mem_id);
     //window.location.replace("http://localhost:8787/PersonalMedi/logincontroller.do?command=snsCheck&member_email="+mem_email+"&sns=N");
     window.location.href="http://localhost:8787/PersonalMedi/logincontroller.do?command=snsCheck&member_email="+mem_email+"&sns=N";   
  }
</script>
