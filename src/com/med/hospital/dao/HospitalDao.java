...
public class HospitalDao {
	...
	public JSONObject getHospital(String sido, String sigungu, String qd, String qn) throws IOException {
...
//		serviceKey = URLEncoder.encode(serviceKey, "UTF-8");
		...
		if(sigungu.equals("구군 선택") || qd.equals("진료과목선택") ) {
